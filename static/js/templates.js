...
var template = fs.readFileSync(__dirname + '/build/templates/logs.hbs', 'utf8');
var logs_template = Handlebars.compile(template);

template = fs.readFileSync(__dirname + '/build/templates/settings.hbs', 'utf8');
var settings_template = Handlebars.compile(template);

template = fs.readFileSync(__dirname + '/build/templates/system_info.hbs', 'utf8');
