...
var template = fs.readFileSync(__dirname + '/static/templates/logs.hbs', 'utf8');
var logs_template = Handlebars.compile(template);

template = fs.readFileSync(__dirname + '/static/templates/settings.hbs', 'utf8');
var settings_template = Handlebars.compile(template);

template = fs.readFileSync(__dirname + '/static/templates/system_info.hbs', 'utf8');
var system_info_template = Handlebars.compile(template);

template = fs.readFileSync(__dirname + '/static/templates/modal.hbs', 'utf8');
