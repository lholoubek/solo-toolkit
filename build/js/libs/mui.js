...
(function e(t, n, r) {
  function s(o, u) {
    ...
    Menu.prototype._createMenuEl = function (wrapperEl, selectEl) {
      ...
      // set position
      var props = formlib.getMenuPositionalCSS(wrapperEl, numOptions, selectedPos);
    ...
    module.exports = {
      ...
      initListeners: function initListeners() {
        ...
        util.onNodeInserted(function (el) {
          if (el.tagName === 'SELECT' && jqLite.hasClass(el.parentNode, wrapperClass)) {
            initialize(el);
          }
        });
      }
    ...
    function eventHandler(ev) {
      ...
      // get height
      if (jqLite.hasClass(buttonEl, btnFABClass)) diameter = offset.height / 2;else diameter = offset.height;
